...
export function CatalogFooter({ meta }) {
  ...
  return (
    <footer className="mx-auto mt-16 max-w-7xl space-y-4 px-4 pb-6 text-center md:px-6 lg:px-8">
      {meta && (
        <div className="inline-flex flex-wrap items-center justify-center gap-x-2 gap-y-1 rounded-full border border-white/5 bg-white/[0.02] px-3 py-1.5 text-[11px] text-zinc-400">
          ...
          {meta.source && (
            <>
              ...
              <span className="truncate font-mono text-[10px] text-zinc-400" title={meta.source}>
                {meta.source}
              </span>
            </>
          )}
      ...
      <div className="space-y-0.5 pt-2">
        <div className="text-[10px] uppercase tracking-[0.32em] text-zinc-400">HoseFinder</div>
        <div className="text-[9px] tracking-[0.18em] text-zinc-400">
